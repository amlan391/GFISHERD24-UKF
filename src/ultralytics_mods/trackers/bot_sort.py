...
# Modified from Ultralytics bot_sort.py
# Modified in 2026 to use the UKF motion model
...
class BOTrack(STrack):
    ...
    Attributes:
        shared_kalman (UKF): A shared Kalman filter for all instances of BOTrack.
    ...
    Examples:
        ...
        >>> bo_track.activate(UKF(), frame_id=1)
        >>> bo_track.predict()
...
class BOTSORT(BYTETracker):
    ...
    Methods:
        get_kalmanfilter: Return an instance of UKF for object tracking.
    ...
    def get_kalmanfilter(self) -> UKF:
        """Return an instance of UKF for predicting and updating object states in the tracking process."""
        return UKF()
